...
export const ClientLifecycle = () => {
  return (
    <Card className="w-full animate-fade-in">
      <CardHeader>
        <CardTitle className="text-center text-2xl bg-gradient-to-r from-[#7B2280] to-[#E40276] bg-clip-text text-transparent">TelePerformance Client Lifecycle Journey</CardTitle>
            ...
            <div className="relative flex justify-between">
              {journeyPhases.map((phase) => (
                <div key={phase.id} className="flex flex-col items-center relative z-10">
                  ...
                  <div className="absolute -bottom-6 transform translate-y-full mt-2 text-center w-24">
